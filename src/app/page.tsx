    ...
    <div className="min-h-screen selection:bg-gold-500/30 selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 xl:px-16 py-8 flex justify-between items-center transition-all duration-500 bg-navy-900/60 backdrop-blur-md border-b border-white/5">
        <div className="text-xl md:text-2xl font-serif tracking-wide flex items-center gap-4">
          <div className="w-8 h-8 md:w-10 md:h-10 border border-gold-500/30 flex items-center justify-center text-white font-serif text-xs md:text-sm">VS</div>
          <span className="font-light">VAHAP SOLMAZGÜL <span className="text-gold-500 text-xs md:text-sm ml-1 md:ml-2 top-[-0.5rem] relative italic">Hukuk</span></span>
        </div>
        ...
        <a href="https://wa.me/905372148445" className="hidden sm:inline-flex text-[10px] uppercase tracking-[0.3em] text-gold-500 border border-gold-500/30 px-6 py-3 hover:bg-gold-500/5 hover:border-gold-500 transition-all">
          Randevu Al
        </a>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-24 pt-32 overflow-hidden">
        {/* Abstract Geometric Background (High Performance LCP) */}
        <div className="absolute inset-0 z-0 bg-navy-900">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] opacity-10" style={{
            background: 'conic-gradient(from 180deg at 50% 50%, #d4af37 0deg, transparent 90deg, #d4af37 180deg, transparent 270deg, #d4af37 360deg)',
            filter: 'blur(120px)'
          }} />
        ...
        <div className="relative z-10 max-w-6xl w-full text-center flex flex-col items-center">
          ...
          <div className="reveal reveal-delay-200">
            <p className="text-slate-400 text-base md:text-xl font-light max-w-2xl mx-auto mb-12 md:mb-16 leading-relaxed">
              Hukuki uyuşmazlıklarda şeffaf, sonuç odaklı ve güvenilir stratejiler. 
              Malatya'da profesyonel avukatlık ve danışmanlık hizmeti.
            </p>
          </div>
          
          <div className="reveal reveal-delay-300 flex flex-col sm:flex-row gap-6 md:gap-8 items-center">
            <a href="https://wa.me/905372148445" className="btn-gold">
              Danışmanlık Al
            </a>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-y border-white/5 reveal reveal-delay-100">
            {[
              { 
                title: "Ceza Hukuku", 
                desc: "Soruşturma ve kovuşturma evrelerinde, temel hakların korunması odağıyla profesyonel ve titiz müdafi hizmeti.",
                num: "I"
              },
              { 
                title: "Ticaret Hukuku", 
                desc: "Şirketler arası uyuşmazlıklar ve kompleks sözleşme süreçlerinde kurumsal hedeflerinizle uyumlu stratejik destek.",
                num: "II"
              },
              { 
                title: "Aile Hukuku", 
                desc: "Gizlilik esaslı boşanma, velayet ve mal rejimi uyuşmazlıklarında hassas ve uzman hukuki danışmanlık.",
                num: "III"
              }
            ].map((area, index) => (
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          ...
          <div className="lg:w-1/2 w-full reveal reveal-delay-200 order-1 lg:order-2">
            ...
            <div className="space-y-6 lg:space-y-8 text-slate-300 font-light text-base lg:text-lg leading-relaxed mb-12 lg:mb-16">
              <p>
                Hukuk, kanunları bilmek değil; <span className="text-white italic font-serif text-xl">adalete giden yolda strateji kurma</span> sanatıdır. Malatya'da yılların getirdiği tecrübe ile her davanın kendi dinamiğini okuyoruz.
              </p>
              <p>
                Küçük detayların büyük sonuçlar doğurduğu hukuki süreçlerde, müvekkillerimize şeffaf, gerçekçi ve çözüm odaklı yaklaşımlar sunuyoruz. Size sadece hukuki destek değil, aynı zamanda güven veriyoruz.
              </p>
            </div>
      ...
      <section id="iletisim" className="py-32 lg:py-48 px-6 lg:px-24 bg-navy-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center reveal">
          ...
          <a href="https://wa.me/905372148445" className="btn-gold px-10 py-4 lg:px-12 lg:py-5 text-[10px] lg:text-sm bg-white/5 backdrop-blur-sm">
            BİZE ULAŞIN
          </a>
        </div>
      </section>
      ...
      <footer className="py-16 lg:py-20 px-6 lg:px-24 bg-black border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16 lg:mb-24">
          <div className="col-span-1 lg:col-span-2">
            <div className="text-xl lg:text-2xl font-serif tracking-wide flex items-center gap-4 mb-6 lg:mb-8">
              <div className="w-8 h-8 border border-white/20 flex items-center justify-center text-white font-serif text-xs">VS</div>
              <span className="font-light text-white">VAHAP SOLMAZGÜL <span className="text-slate-500 text-sm ml-1 lg:ml-2 top-[-0.3rem] lg:top-[-0.5rem] relative italic">Hukuk</span></span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-slate-400 text-sm font-light">
              <p>T: +90 537 214 84 45</p>
              <p>E: info@vahapsolmazgul.av.tr</p>
              <p className="pt-2 lg:pt-4 leading-relaxed">Malatya Park Ofis, İnönü,<br/>Kat:3 Daire:18 Yeşilyurt, Malatya</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-[9px] lg:text-[10px] uppercase tracking-[0.2em] text-slate-600 text-center md:text-left">
            © {new Date().getFullYear()} Vahap Solmazgül Hukuk Bürosu. Tüm Hakları Saklıdır.
          </div>
